            ...
            <div class="container">
               <div class="row">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="phplogin.php">Login</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="phpregister.php">Register</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
                  ...
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5">
                     <ul class="email">
                        <li><a href="#">Call: (+91) 9123456780</a></li>
      ...
      <div id="about"  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-9">
                  <div class="titlepage">
                     <h2> <img src="images/head.h.png" alt="#"/>About Our Spalab</h2>
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="container">
                        <div class="carousel-caption ">
                           <div class="test_box">
                              <i><img src="images/a1.jpeg" alt="#"/></i>
                              <h4>Arriana Grande</h4>
                              <span>Customer</span>
      ...
      <div id="contact" class="contact">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2> <img src="images/head.h.png" alt="#"/><span class="white">REQUEST A CALL BACK</span></h2>
                  </div>
               </div>
            </div>
            <div class="row">
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 All Rights Reserved. <a href="https://html.design/">Aayeshna</a></p>
                     </div>
                  </div>
               </div>
            </div>
